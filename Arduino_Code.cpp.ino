...
class Algorithm {
  public:
    ...
    void reset();
    int set(String);
    void move_and_print_string(String);
    void make_copy();
    void U();
    void Ui();
    void D();
...
Algorithm::Algorithm(String input_cube) {
...
int Algorithm::set(String input_cube) {
  int W_count = 0;
  int O_count = 0;
  int G_count = 0;
  int R_count = 0;
...
void Algorithm::move_and_print_string(String movement) {
...
void setup() {
  ...
  String OWEN = "WWWWWWWWWOOOOOOOOOGGGGGGGGGRRRRRRRRRBBBBBBBBBYYYYYYYYY";
  Algorithm a(OWEN);
  a.solve();
}
